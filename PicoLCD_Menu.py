#I have tried to work with module MenuSystem but it does not work at the moment
#I have to try it
...
#slut
#fra MenuSystem i stedet for et modul 
MenuText=[1,2]
MenuFunction=[]
...
if __name__=='__main__':
    ...
    time.sleep(1)
    LCD.fill(0xFFFF)
    LCD.text("ZEINEB LCD Menu",2,8,LCD.RED)
    LCD.show()
    ...
    #ms.add("Led On", TurnOn)
    #ms.add("Led Off", TurnOff)
    #run()
